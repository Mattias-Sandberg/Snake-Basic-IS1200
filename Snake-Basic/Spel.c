...
int applen_y[] = { 10, 29, 20, 9, 15, 3, 21, 27, 11, 17, 8, 12, 49, 52, 19, 30 };
int applen_x[] = { 56, 39, 28, 95, 46, 107, 13, 69, 65, 11, 28, 82, 96, 74, 5, 66 };
...
void kollision()
{
    ...
    {
        display_string(0, "IF HE DIES");
	display_string(1, "HE DIES");
